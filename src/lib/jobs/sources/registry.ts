...
/**
 * All known source adapters. Adding a real source later (Adzuna, a
 * partner feed, ...) means writing one file implementing JobSourceAdapter
 * and adding it here — nothing else in the ingestion pipeline changes.
 */
export const ALL_SOURCES: JobSourceAdapter[] = [demoSource, franceTravailSource];
